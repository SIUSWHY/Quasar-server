...
const getCurrentUser = express_1.default.Router();
getCurrentUser.get('/currentUser', verifyToken_1.default, (req, res, _next) => __awaiter(void 0, void 0, void 0, function* () {
    const auth = req.data.user;
    const CurrentUser = yield modelUser_1.default.findOne({
        _id: auth._id
    });
